...
<div class="card form-card">
    <form method="POST" action="{{ $action }}" enctype="multipart/form-data" class="form-layout">
        ...
        <section class="form-section">
            <div>
                <h2 class="form-section-title">Informasi utama kamar</h2>
                <p class="form-section-copy">Isi identitas, harga, dan status kamar. Slug akan dibuat otomatis dari nama saat data disimpan.</p>
            </div>
        ...
        <section class="form-section">
            <div>
                <h2 class="form-section-title">Fasilitas kamar</h2>
                <p class="form-section-copy">Pilih fasilitas yang tersedia untuk kamar ini. Anda bisa memilih lebih dari satu fasilitas dari tiap kelompok.</p>
            </div>
        ...
        <section class="form-section">
            <div>
                <h2 class="form-section-title">Media kamar</h2>
                <p class="form-section-copy">Unggah foto utama kamar jika tersedia. File akan disimpan ke storage Laravel.</p>
            </div>
