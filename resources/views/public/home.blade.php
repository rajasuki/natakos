    ...
    <section class="page-section">
        <div class="site-shell hero">
            ...
            <aside class="hero-card">
                ...
                <p class="muted">Alamat: {{ $profile['address'] }}</p>
            </aside>
        </div>
    </section>
    ...
    <section class="page-section section-dark">
        <div class="site-shell">
            <div class="section-header">
                ...
                <p class="section-copy" style="color: #afafaf;">NATAKOS mengelola kombinasi fasilitas kamar dan fasilitas umum agar kebutuhan harian penghuni tetap praktis.</p>
            </div>
    ...
    <section class="page-section">
        <div class="site-shell">
            <section class="contact-band">
                ...
                <h2 class="section-title" style="margin-bottom: 12px;">Butuh informasi kamar lebih cepat?</h2>
