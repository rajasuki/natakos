...
<style>
    ...
    .chat-box { background:#fff; border:1px solid var(--ui-border); border-radius:var(--radius-xl); overflow:hidden; display:flex; flex-direction:column; height:calc(100vh - 220px); min-height:420px;box-shadow:0 2px 12px rgba(0,0,0,.04); }
    ...
    .chat-bubble-text { font-size:14px;line-height:1.6;color:var(--ui-ink);word-wrap:break-word;white-space:pre-wrap;margin-top:1px; }
